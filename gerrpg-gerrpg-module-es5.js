...
var RpgUpdateComponent = /** @class */ (function () {
    function RpgUpdateComponent(formBuilder, storage, alertController, rpgService, paginaService, toast, modalCtrl) {
    ...
    RpgUpdateComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.requestUpdate = false;
        this.loading = true;
        var id = this.rpgService.getStaticID();
        this.rpgService.findById(id)
            .subscribe(function (res) {
            var idMapa = res.idMapa, descricao = res.descricao, nome = res.nome, imgURL = res.imgURL, isPrivate = res.isPrivate, historia = res.historia;
            _this.formRPG.get('nome').setValue(nome);
            _this.formRPG.get('descricao').setValue(descricao);
            _this.formRPG.get('historia').setValue(historia);
            _this.formRPG.get('imgURL').setValue(imgURL);
            if (isPrivate == false) {
                _this.formRPG.get('isPrivate').setValue(false);
            }
            else {
                _this.formRPG.get('isPrivate').setValue(true);
            }
            _this.loading = false;
        }, function (error) {
            console.log(error);
    ...
    RpgUpdateComponent.prototype.salvar = function () {
        var _this = this;
        var idRpg = this.rpgService.getStaticID();
        ...
        this.rpgService.updateBasic(this.newRPG)
            .subscribe(function (res) {
            _this.loading = false;
            _this.callToast('success', 'Atualizado com sucesso!', 'RPG atualizado');
        }, function (error) {
            _this.loading = false;
        });
    };
    RpgUpdateComponent.prototype.novoMapa = function () {
        this.display = false;
        this.novo = true;
    };
    RpgUpdateComponent.prototype.listar = function () {
        this.display = true;
        this.novo = false;
    };
    RpgUpdateComponent.prototype.getNotification = function (evt) {
        if (this.paginaAtual != evt) {
            this.paginaAtual = evt;
            this.consultar();
        }
    };
    RpgUpdateComponent.prototype.consultar = function () {
        var p = this.rpgService.findPageByCriador(this.paginaAtual.toString());
        this.paginaService.setPromisse(p);
        this.listar();
    };
    RpgUpdateComponent.prototype.presentAdicionar = function (id) {
    ...
    RpgUpdateComponent.prototype.copyToClipboard = function (value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var id;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                id = function (e) {
    ...
    RpgUpdateComponent.prototype.close = function () {
        this.modalCtrl.dismiss(this.requestUpdate, null, 'princi');
    };
    RpgUpdateComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.add({
            severity: severity,
            summary: summary,
            detail: detail
    ...
    RpgUpdateComponent.ctorParameters = function () { return [
...
var RpgUpdateModule = /** @class */ (function () {
    function RpgUpdateModule() {
    }
...
var GerrpgPage = /** @class */ (function () {
    function GerrpgPage(storage, paginaService, modalCtrl, rpgService) {
        this.storage = storage;
        this.paginaService = paginaService;
        this.modalCtrl = modalCtrl;
        this.rpgService = rpgService;
    ...
    GerrpgPage.prototype.novoRPG = function () {
        this.display = false;
        this.novo = true;
    };
    GerrpgPage.prototype.listar = function () {
        this.display = true;
        this.novo = false;
    };
    GerrpgPage.prototype.consultar = function () {
        var p = this.rpgService.findPageByCriador(this.paginaAtual.toString());
        this.paginaService.setPromisse(p);
        this.listar();
    };
    GerrpgPage.prototype.getNotification = function (evt) {
        if (this.paginaAtual != evt) {
            this.paginaAtual = evt;
            this.consultar();
        }
    };
    GerrpgPage.prototype.selectedObj = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            //console.log(res);
                            if (data == true) {
                                var p = _this.rpgService.findPageByCriador(_this.paginaAtual.toString());
    ...
    GerrpgPage.prototype.getSelectedObj = function (evt) {
        this.obj.emit(evt);
    };
    GerrpgPage.prototype.actionObj = function (event) {
    ...
    GerrpgPage.ctorParameters = function () { return [
