...
let HallPage = class HallPage {
    constructor(auth, router, authService, storage, user) {
        this.auth = auth;
        this.router = router;
    ...
    checkRefresh() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.authService.refreshToken()
                .subscribe(res => {
                this.loading = false;
                this.authService.loginSucesso(res.headers.get('Authorization'));
                this.regainId();
            }, error => {
...
//# sourceMappingURL=hall-hall-module-es2015.js.map