...
var MissaoDetailComponent = /** @class */ (function () {
    function MissaoDetailComponent(modal, modalInterno, detalharService, missaoService, toast) {
        this.modal = modal;
    ...
    MissaoDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        var id = this.detalharService.getId();
        this.missaoService.findById(id)
            .subscribe(function (res) {
            _this.missao = res;
            _this.recompensas = res.recompensas;
            _this.loading = false;
        }, function (error) {
            console.log(error);
            _this.loading = false;
    ...
    MissaoDetailComponent.prototype.close = function () {
        this.modal.dismiss(null, null, "capitulo-detail");
    };
    MissaoDetailComponent.prototype.mudaAba = function (event) {
    };
    MissaoDetailComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.clear();
        this.toast.add({
            severity: severity,
            summary: summary,
    ...
    MissaoDetailComponent.prototype.getRecompensas = function (recompensas) {
        var recompensa = recompensas.join(', ');
        return recompensa;
    };
    MissaoDetailComponent.ctorParameters = function () { return [
...
var MissaoDetailModule = /** @class */ (function () {
    function MissaoDetailModule() {
    }
...
var ExploreMissaoPageRoutingModule = /** @class */ (function () {
    function ExploreMissaoPageRoutingModule() {
    }
    ...
    return ExploreMissaoPageRoutingModule;
}());
...
var ExploreMissaoPageModule = /** @class */ (function () {
    function ExploreMissaoPageModule() {
    }
    ...
    return ExploreMissaoPageModule;
}());
...
var ExploreMissaoPage = /** @class */ (function () {
    function ExploreMissaoPage(auth, missaopage, modal, detalharService, toast, alertContr, missaoService) {
        this.auth = auth;
    ...
    ExploreMissaoPage.prototype.ngOnInit = function () {
    };
    ExploreMissaoPage.prototype.isLogedIn = function () {
        return this.auth.isLogedIn();
    };
    ExploreMissaoPage.prototype.mudaAba = function (event) {
    ...
    ExploreMissaoPage.prototype.consultar = function (page) {
        var _this = this;
        this.loading = true;
    ...
    ExploreMissaoPage.prototype.pesquisar = function (page) {
        var _this = this;
        this.loading = true;
    ...
    ExploreMissaoPage.prototype.detalhar = function (id) {
        this.detalharService.setId(id);
        this.showModal();
    };
    ExploreMissaoPage.prototype.paginar = function (evt) {
        var page = evt.page;
        console.log(page);
        this.consultar(page.toString());
    };
    ExploreMissaoPage.prototype.showModal = function () {
    ...
    ExploreMissaoPage.prototype.handle404 = function (e) {
        this.flagSearched = false;
        this.callToast('warn', 'Famoso 404', 'Infelizmente não encontramos nada com essa palavra');
    };
    ExploreMissaoPage.prototype.callToast = function (severity, summary, detail, life) {
    ...
    ExploreMissaoPage.prototype.showDetail = function (projecao) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    ExploreMissaoPage.prototype.copiar = function (id) {
        var _this = this;
    ...
    ExploreMissaoPage.ctorParameters = function () { return [
...
var MissaoPageService = /** @class */ (function () {
    function MissaoPageService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    MissaoPageService.prototype.findPageByNewer = function (page, linesPerPage) {
        if (page === void 0) { page = '0'; }
    ...
    MissaoPageService.prototype.findPageBySearch = function (page, descricao, orderBy, direction, linesPerPage) {
        if (page === void 0) { page = '0'; }
        if (linesPerPage === void 0) { linesPerPage = '10'; }
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('page', page)
    ...
    MissaoPageService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
//# sourceMappingURL=explorar-explore-missao-explore-missao-module-es5.js.map