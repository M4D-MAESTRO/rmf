...
let SuportePage = class SuportePage {
    constructor(toast, formBuilder, notify, storage, auth) {
        this.toast = toast;
    ...
    enviar() {
        ...
        this.notify.contact({ email, motivo, descricao })
            .subscribe(res => {
