...
var RpgDetailComponent = /** @class */ (function () {
    function RpgDetailComponent(modal, modalInterno, detalharService, rpgService, toast) {
        this.modal = modal;
    ...
    RpgDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        var id = this.detalharService.getId();
        this.rpgService.findById(id)
            .subscribe(function (res) {
            console.log(res);
            var nome = res.nome, imgURL = res.imgURL, historia = res.historia, descricao = res.descricao, tipoRPG = res.tipoRPG, faccoesBoas = res.faccoesBoas, faccoesHostis = res.faccoesHostis, faccoesNeutras = res.faccoesNeutras, capitulos = res.capitulos, aliados = res.aliados, neutros = res.neutros, inimigos = res.inimigos, sistemas = res.sistemas, mapas = res.mapas;
            _this.rpg = {
                nome: nome,
                imgURL: imgURL,
                historia: historia,
            ...
            _this.faccoesBoas = faccoesBoas;
            _this.faccoesHostis = faccoesHostis;
            _this.faccoesNeutras = faccoesNeutras;
            _this.capitulos = capitulos;
            _this.npcsAliado = aliados;
            _this.npcsInimigos = inimigos;
            _this.npcsNeutros = neutros;
            _this.regras = sistemas;
            _this.mapas = mapas;
            _this.loading = false;
        }, function (error) {
            console.log(error);
    ...
    RpgDetailComponent.prototype.close = function () {
        this.modal.dismiss(null, null, "rpg-detail");
    };
    RpgDetailComponent.prototype.mudaAba = function (event) {
        this.selectedCapitulo = undefined;
        console.log(this.mapas);
    };
    RpgDetailComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.clear();
        this.toast.add({
            severity: severity,
            summary: summary,
    ...
    RpgDetailComponent.prototype.getRecompensas = function (recompensas) {
        var recompensa = recompensas.join(', ');
        return recompensa;
    };
    RpgDetailComponent.prototype.exibeDescricao = function (message) {
    ...
    RpgDetailComponent.prototype.zoomedImage = function (image) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RpgDetailComponent.prototype.setSelectedCapitulo = function (event) {
        var value = event.detail.value;
        this.selectedCapitulo = value;
        this.missoes = value.missoes;
    };
    RpgDetailComponent.prototype.setSelectedNpc = function (npc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RpgDetailComponent.ctorParameters = function () { return [
...
/* harmony import */ var primeng_accordion__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/accordion */ "./node_modules/primeng/fesm5/primeng-accordion.js");
...
var RpgDetailModule = /** @class */ (function () {
    function RpgDetailModule() {
    }
...
var ImagemZoomedComponent = /** @class */ (function () {
    function ImagemZoomedComponent(modalCtrl, service, toast) {
    ...
    ImagemZoomedComponent.prototype.ngOnInit = function () {
    ...
    ImagemZoomedComponent.prototype.close = function () {
        this.modalCtrl.dismiss(this.src);
    };
    ImagemZoomedComponent.prototype.getImg = function () {
    ...
    ImagemZoomedComponent.prototype.getImgZoomed = function () {
    ...
    ImagemZoomedComponent.prototype.update = function () {
        var p = this.service.getPromisse();
        p.subscribe(function (res) { return console.log(res); });
    };
    ImagemZoomedComponent.prototype.zoom = function () {
        this.isZoomed = !this.isZoomed;
    };
    ImagemZoomedComponent.prototype.showLightbox = function (index) {
        this.selectedImageIndex = index;
        this.showFlag = true;
    };
    ImagemZoomedComponent.prototype.closeEventHandler = function () {
        this.close();
    };
    ImagemZoomedComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
var ImagemZoomedModule = /** @class */ (function () {
    function ImagemZoomedModule() {
    }
...
var PresentDescriptionComponent = /** @class */ (function () {
    function PresentDescriptionComponent(modal) {
        this.modal = modal;
    }
    PresentDescriptionComponent.prototype.ngOnInit = function () {
    };
    PresentDescriptionComponent.prototype.close = function () {
        this.modal.dismiss();
    };
    PresentDescriptionComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return PresentDescriptionComponent;
}());
...
var PresentDescriptionModule = /** @class */ (function () {
    function PresentDescriptionModule() {
    }
    ...
    return PresentDescriptionModule;
}());
...
var ExploreRpgPageRoutingModule = /** @class */ (function () {
    function ExploreRpgPageRoutingModule() {
    }
    ...
    return ExploreRpgPageRoutingModule;
}());
...
var ExploreRpgPageModule = /** @class */ (function () {
    function ExploreRpgPageModule() {
    }
...
var ExploreRpgPage = /** @class */ (function () {
    function ExploreRpgPage(auth, rpgPage, modal, detalharService, toast, alertContr, rpgService) {
        this.auth = auth;
    ...
    ExploreRpgPage.prototype.ngOnInit = function () {
    };
    ExploreRpgPage.prototype.isLogedIn = function () {
        return this.auth.isLogedIn();
    };
    ExploreRpgPage.prototype.mudaAba = function (event) {
    ...
    ExploreRpgPage.prototype.consultar = function (page) {
        var _this = this;
        this.loading = true;
    ...
    ExploreRpgPage.prototype.pesquisar = function (page) {
        var _this = this;
        this.loading = true;
    ...
    ExploreRpgPage.prototype.detalhar = function (id) {
        this.detalharService.setId(id);
        this.showModal();
    };
    ExploreRpgPage.prototype.paginar = function (evt) {
        var page = evt.page;
        console.log(page);
        this.consultar(page.toString());
    };
    ExploreRpgPage.prototype.showModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ExploreRpgPage.prototype.handle404 = function (e) {
        this.flagSearched = false;
        this.callToast('warn', 'Famoso 404', 'Infelizmente não encontramos nada com essa palavra');
    };
    ExploreRpgPage.prototype.callToast = function (severity, summary, detail, life) {
    ...
    ExploreRpgPage.prototype.showDetail = function (projecao) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    ExploreRpgPage.prototype.copiar = function (id) {
        var _this = this;
    ...
    ExploreRpgPage.ctorParameters = function () { return [
...
var RpgPageService = /** @class */ (function () {
    function RpgPageService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    RpgPageService.prototype.findPageByNewer = function (page, linesPerPage) {
    ...
    RpgPageService.prototype.findPageBySearch = function (page, descricao, orderBy, direction, linesPerPage) {
        if (page === void 0) { page = '0'; }
        if (linesPerPage === void 0) { linesPerPage = '10'; }
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('page', page)
    ...
    RpgPageService.ctorParameters = function () { return [
...
//# sourceMappingURL=explorar-explore-rpg-explore-rpg-module-es5.js.map