...
var RpgFormComponent = /** @class */ (function () {
    function RpgFormComponent(formBuilder, storage, alertController, rpgService, toast) {
    ...
    RpgFormComponent.prototype.confirmar = function () {
        this.toast.clear();
        this.toast.add({ key: 'c', sticky: true, severity: 'warn', summary: 'Are you sure?', detail: '' });
    };
    RpgFormComponent.prototype.onConfirm = function () {
        this.proximo();
    };
    RpgFormComponent.prototype.onReject = function () {
        this.toast.clear();
    };
...
var RpgComponent = /** @class */ (function () {
    ...
    RpgComponent.prototype.ngOnDestroy = function () {
        this.rpgService.setDoUpdate(true);
    };
    RpgComponent.prototype.ionViewWillLeave = function () {
        this.rpgService.setDoUpdate(true);
    };
    ...
    RpgComponent.prototype.voltar = function (evt) {
