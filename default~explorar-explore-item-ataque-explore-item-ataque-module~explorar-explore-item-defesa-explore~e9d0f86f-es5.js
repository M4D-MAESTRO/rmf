...
var ItemDetailComponent = /** @class */ (function () {
    function ItemDetailComponent(modal, modalInterno, detalharService, itemService, toast) {
        this.modal = modal;
    ...
    ItemDetailComponent.prototype.mudaAba = function (event) {
    };
    ItemDetailComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.clear();
        this.toast.add({
            severity: severity,
            summary: summary,
    ...
    ItemDetailComponent.prototype.openModal = function (event) {
...
//# sourceMappingURL=default~explorar-explore-item-ataque-explore-item-ataque-module~explorar-explore-item-defesa-explore~e9d0f86f-es5.js.map