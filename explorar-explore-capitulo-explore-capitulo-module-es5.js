...
var CapituloDetailComponent = /** @class */ (function () {
    function CapituloDetailComponent(modal, modalInterno, detalharService, capituloService, toast) {
        this.modal = modal;
    ...
    CapituloDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CapituloDetailComponent.prototype.close = function () {
        this.modal.dismiss(null, null, "capitulo-detail");
    };
    CapituloDetailComponent.prototype.mudaAba = function (event) {
    };
    CapituloDetailComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.clear();
        this.toast.add({
            severity: severity,
            summary: summary,
    ...
    CapituloDetailComponent.prototype.getRecompensas = function (recompensas) {
        var recompensa = recompensas.join(', ');
        return recompensa;
    };
    CapituloDetailComponent.ctorParameters = function () { return [
    ...
    return CapituloDetailComponent;
}());
...
var CapituloDetailModule = /** @class */ (function () {
    function CapituloDetailModule() {
    }
...
var ExploreCapituloPageRoutingModule = /** @class */ (function () {
    function ExploreCapituloPageRoutingModule() {
    }
    ...
    return ExploreCapituloPageRoutingModule;
}());
...
var ExploreCapituloPageModule = /** @class */ (function () {
    function ExploreCapituloPageModule() {
    }
    ...
    return ExploreCapituloPageModule;
}());
...
var ExploreCapituloPage = /** @class */ (function () {
    function ExploreCapituloPage(auth, capituloPage, modal, detalharService, toast, alertContr, capituloService) {
        this.auth = auth;
    ...
    ExploreCapituloPage.prototype.ngOnInit = function () {
    };
    ExploreCapituloPage.prototype.isLogedIn = function () {
        return this.auth.isLogedIn();
    };
    ExploreCapituloPage.prototype.mudaAba = function (event) {
    ...
    ExploreCapituloPage.prototype.consultar = function (page) {
        var _this = this;
        this.loading = true;
    ...
    ExploreCapituloPage.prototype.pesquisar = function (page) {
        var _this = this;
        this.loading = true;
    ...
    ExploreCapituloPage.prototype.detalhar = function (id) {
        this.detalharService.setId(id);
        this.showModal();
    };
    ExploreCapituloPage.prototype.paginar = function (evt) {
        var page = evt.page;
        console.log(page);
        this.consultar(page.toString());
    };
    ExploreCapituloPage.prototype.showModal = function () {
    ...
    ExploreCapituloPage.prototype.handle404 = function (e) {
        this.flagSearched = false;
        this.callToast('warn', 'Famoso 404', 'Infelizmente não encontramos nada com essa palavra');
    };
    ExploreCapituloPage.prototype.callToast = function (severity, summary, detail, life) {
    ...
    ExploreCapituloPage.prototype.showDetail = function (projecao) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    ExploreCapituloPage.prototype.copiar = function (id) {
        var _this = this;
    ...
    ExploreCapituloPage.ctorParameters = function () { return [
...
var CapituloPageService = /** @class */ (function () {
    function CapituloPageService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    CapituloPageService.prototype.findPageByNewer = function (page, linesPerPage) {
        if (page === void 0) { page = '0'; }
        if (linesPerPage === void 0) { linesPerPage = '10'; }
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('page', page)
    ...
    CapituloPageService.prototype.findPageBySearch = function (page, descricao, orderBy, direction, linesPerPage) {
        if (page === void 0) { page = '0'; }
        if (linesPerPage === void 0) { linesPerPage = '10'; }
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('page', page)
    ...
    CapituloPageService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
//# sourceMappingURL=explorar-explore-capitulo-explore-capitulo-module-es5.js.map