...
let FaccaoDetailComponent = class FaccaoDetailComponent {
    constructor(modal, modalInterno, detalharService, faccaoService, toast) {
        this.modal = modal;
...
FaccaoDetailComponent.ctorParameters = () => [
...
let FaccaoDetailModule = class FaccaoDetailModule {
};
...
let ExploreFaccaoPageRoutingModule = class ExploreFaccaoPageRoutingModule {
};
...
let ExploreFaccaoPageModule = class ExploreFaccaoPageModule {
};
...
let ExploreFaccaoPage = class ExploreFaccaoPage {
    constructor(auth, router, faccaoPage, modal, detalharService, toast, alertContr, faccaoService) {
        this.auth = auth;
        this.router = router;
...
ExploreFaccaoPage.ctorParameters = () => [
...
let FaccaoPageService = class FaccaoPageService {
    constructor(http, storage) {
        this.http = http;
        this.storage = storage;
    }
...
FaccaoPageService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
//# sourceMappingURL=explorar-explore-faccao-explore-faccao-module-es2015.js.map