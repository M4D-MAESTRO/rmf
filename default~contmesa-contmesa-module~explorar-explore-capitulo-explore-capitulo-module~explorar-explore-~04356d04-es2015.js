...
let PresentAtaqueComponent = class PresentAtaqueComponent {
    constructor(modal) {
        this.modal = modal;
...
PresentAtaqueComponent.ctorParameters = () => [
...
let PresentAtaqueModule = class PresentAtaqueModule {
};
...
let PresentDefesaComponent = class PresentDefesaComponent {
    constructor(modal) {
        this.modal = modal;
        this.fullPresentation = false;
    }
...
PresentDefesaComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('item'),
...
let PresentDefesaModule = class PresentDefesaModule {
};
...
let PresentUtilizavelComponent = class PresentUtilizavelComponent {
    constructor(modal) {
        this.modal = modal;
        this.fullPresentation = false;
    }
...
PresentUtilizavelComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('item'),
...
let PresentUtilizavelModule = class PresentUtilizavelModule {
};
...
let ItemService = class ItemService {
    ...
    findPageOfAtaque(page = '0', linesPerPage = '20') {
        const orderBy = 'nome';
    ...
    findPageOfDefesa(page = '0', linesPerPage = '20') {
        const orderBy = 'nome';
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idCriador', this.storage.getLocalUserId())
            .set('page', page)
    ...
    findPageOfUtilizavel(page = '0', linesPerPage = '20') {
        const orderBy = 'nome';
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idCriador', this.storage.getLocalUserId())
            .set('page', page)
...
let DetalharService = class DetalharService {
    constructor() { }
    getId() {
        return this.id;
    }
...
//# sourceMappingURL=default~contmesa-contmesa-module~explorar-explore-capitulo-explore-capitulo-module~explorar-explore-~04356d04-es2015.js.map